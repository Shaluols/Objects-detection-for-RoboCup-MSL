...
void RegistrationImpl::apply(const Frame *rgb, const Frame *depth, Frame *undistorted, Frame *registered, const bool enable_filter, Frame *bigdepth, int *color_depth_map) const
{
  ...
  const float *map_x = depth_to_color_map_x;//every depth pixels mapping the related color pixel
 ...
 // printf("color_cx %f %f %f %f\n",color.cx,color.cy,color.fx,color.fy);
 // color_cx 959.500000 539.500000 1081.372070 1081.372070
