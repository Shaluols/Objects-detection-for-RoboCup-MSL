...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.ballinfo.header.seq, _x.ballinfo.header.stamp.secs, _x.ballinfo.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ballinfo.header.seq, _x.ballinfo.header.stamp.secs, _x.ballinfo.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.ballinfo.ballinfostate, _x.ballinfo.pos.x, _x.ballinfo.pos.y, _x.ballinfo.real_pos.angle, _x.ballinfo.real_pos.radius, _x.ballinfo.velocity.x, _x.ballinfo.velocity.y, _x.ballinfo.pos_known, _x.ballinfo.velocity_known, _x.obstacleinfo.header.seq, _x.obstacleinfo.header.stamp.secs, _x.obstacleinfo.header.stamp.nsecs,) = _struct_i6f2B3I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_v10.theta,) = _struct_f.unpack(str[start:end])
        start = end
        end += 4
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.robotinfo:
        ...
        buff.write(_struct_2f.pack(_x.x, _x.y))
        _v16 = val1.heading
        buff.write(_struct_f.pack(_v16.theta))
        buff.write(_struct_f.pack(val1.vrot))
        _v17 = val1.vtrans
        _x = _v17
        buff.write(_struct_2f.pack(_x.x, _x.y))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v22.theta,) = _struct_f.unpack(str[start:end])
        start = end
        end += 4
        (val1.vrot,) = _struct_f.unpack(str[start:end])
        _v23 = val1.vtrans
