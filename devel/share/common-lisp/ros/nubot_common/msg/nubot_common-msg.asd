...
(defsystem "nubot_common-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "object_info" :depends-on ("_package_object_info"))
    (:file "_package_object_info" :depends-on ("_package"))
    ...
    (:file "ObstaclesInfo3d" :depends-on ("_package_ObstaclesInfo3d"))
    (:file "_package_ObstaclesInfo3d" :depends-on ("_package"))
